...
def generate_upset_plot():
    ...
    csv_path = os.path.join(META_RESULTS_DIR, 'upset_plot_data.csv')
    ...
    plot_path = os.path.join(META_RESULTS_DIR, 'upset_plot.png')
    ...
    pan_csv = os.path.join(META_RESULTS_DIR, 'pan_cancer_23_genes.csv')
...
def generate_network_plot(pan_cancer_genes):
    ...
    # Export Network CSV
    csv_path = os.path.join(META_RESULTS_DIR, 'metabolite_target_network_edges.csv')
    ...
    plot_path = os.path.join(META_RESULTS_DIR, 'metabolite_target_network.png')
    plt.tight_layout()
    plt.savefig(plot_path, dpi=300, bbox_inches='tight')
    plt.close()
