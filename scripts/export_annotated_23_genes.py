...
# 1. Read 23 genes
genes_file = os.path.join(META_RESULTS_DIR, 'pan_cancer_23_genes.csv')
if not os.path.exists(genes_file):
    print("pan_cancer_23_genes.csv not found!")
    exit(1)
...
out_file = os.path.join(META_RESULTS_DIR, 'pan_cancer_23_genes_with_annotation.csv')
